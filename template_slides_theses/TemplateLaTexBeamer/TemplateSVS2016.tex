...
\begin{frame}
	...
	\par\vspace{-6.0cm} % Cursor nach oben (minus x) bewegen
	\includegraphics[height=25px]{../pic/sword.pdf} % https://upload.wikimedia.org/wikipedia/commons/1/19/Sword_01.svg
	\par\vspace{1.8cm} % Cursor nach unten bewegen
	\includegraphics[height=25px]{../pic/shield.pdf} % https://commons.wikimedia.org/wiki/File:Weapon_shield.svg - CC-0
\end{frame}
